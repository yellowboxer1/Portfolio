...
export function MetricsTabs({ tabs, activeIndex, onChange }: MetricsTabsProps) {
  return (
    <div
      ...
      className="flex w-full flex-col gap-3 md:flex-row md:gap-10"
    >
      {tabs.map((tab, index) => {
        ...
        return (
          <button
            ...
            className={`border-b pb-3 text-left text-[13px] font-medium uppercase leading-none tracking-[0.18em] transition-colors md:min-h-[44px] md:max-w-[220px] md:text-[17px] ${
              isActive
