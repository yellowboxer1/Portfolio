...
const ufbg = withBasePath('/portfolio/zigzag-reverse/assets/image/ufbg@3x.webp');
const wireframe = withBasePath('/portfolio/zigzag-reverse/assets/image/wireframe.webp');
const flow = withBasePath('/portfolio/zigzag-reverse/assets/image/flow@3x.png');

const UserFlowChart = () => {
  	return (
    		<div className={styles.userFlowchart}>
          <img loading="lazy" decoding="async" className={styles.userFlowBg} src={ufbg} />
          ...
          <img loading="lazy" decoding="async" className={styles.flowIcon} src={flow} />
            <img loading="lazy" decoding="async" className={styles.wireframeIcon} src={wireframe} />
    		</div>);
};
